...
const INTERVAL_MS: i32 = TIMEOUT_MS;
const PROLONGED_INTERVAL_MS: i32 = TIMEOUT_MS * 5;
const ANIMATION_INTERVAL_MS: i32 = 200;
const ANIMATION_RATIO: f64 = 0.05;
...
const PIXEL_SHIFT_WIDTH_PX: u64 = 22; // should be divisible by 2
...
fn interval_for_state(state: ShiftState) -> i32 {
    match state {
...
impl Default for PixelShiftManager {
    fn default() -> Self {
        Self::new()
    }
}
...
impl PixelShiftManager {
    ...
    pub fn update(&mut self) -> (bool, i32) {
        ...
        if since_last_pixel_shift < interval_for_state(self.state) {
        ...
        (true, interval_for_state(self.state))
    }
